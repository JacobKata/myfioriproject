sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("coct/zdownload/app", ".html");
		...
		return Opa5.extend("coct.zdownload.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["coct/zdownload/localService/mockserver"], function (mockserver) {
